...
######################################################
"""
    ftforwindow(data::Array, duration::Number, avginterval::AbstractFloat)
...
"""
    spectralenergydensity(FTin::Vector, duration)
...
"""
    findcutofffreq(freqin::Vector, flim)::Integer
...
"""
    lowpass(ftrawin::Vector, idxlim::Integer)::Vector
...
"""
    ibelltaper(invec::Vector)::Vector
...
######################################################
"""
    lowpassallinone(invect::Vector, dur, fco)::Vector
...
"""
    fouriercutoffmatrix(inmatrix::Array, dur, fco)
...
######################################################
"""
    logavg(inputvecx::Vector, inputvecy::Vector,
    interval)
